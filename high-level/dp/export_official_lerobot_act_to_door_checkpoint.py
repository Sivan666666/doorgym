...
def main():
    ...
    backend = LeRobotActDoorPolicyBackend.create(
        ...
        freeze_vision_backbone=policy_config.get("freeze_vision_backbone"),
        ...
        defm_image_size=int(policy_config.get("defm_image_size", 224)),
        defm_patch_size=int(policy_config.get("defm_patch_size", 14)),
        defm_feature_grid_size=int(policy_config.get("defm_feature_grid_size", 6)),
        defm_depth_lower=float(policy_config.get("defm_depth_lower", 0.02)),
        defm_depth_far=float(policy_config.get("defm_depth_far", 2.0)),
        defm_pretrained=bool(policy_config.get("defm_pretrained", True)),
        defm_pretrained_path=policy_config.get("defm_pretrained_path"),
        camera_input_gating=bool(policy_config.get("camera_input_gating", False)),
        camera_input_gating_hidden_dim=int(policy_config.get("camera_input_gating_hidden_dim", 128)),
        camera_input_gating_temperature=float(policy_config.get("camera_input_gating_temperature", 1.0)),
        camera_input_gating_front_key=policy_config.get("camera_input_gating_front_key"),
        camera_input_gating_wrist_key=policy_config.get("camera_input_gating_wrist_key"),
        plucker_conditioning=bool(policy_config.get("plucker_conditioning", False)),
        plucker_front_pose_key=policy_config.get("plucker_front_pose_key", "observation.camera_pose.front"),
        plucker_wrist_pose_key=policy_config.get("plucker_wrist_pose_key", "observation.camera_pose.wrist"),
        plucker_encoder_channels=policy_config.get("plucker_encoder_channels", "32,64"),
        ...
        handle_latent_front_key=policy_config.get("handle_latent_front_key", "aux.front_handle_latent"),
        handle_latent_front_valid_key=policy_config.get(
            "handle_latent_front_valid_key",
            "aux.front_handle_latent_valid",
        ),
        handle_latent_wrist_key=policy_config.get("handle_latent_wrist_key", "aux.wrist_handle_latent"),
        handle_latent_wrist_valid_key=policy_config.get(
