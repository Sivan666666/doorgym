...
def make_lerobot_act_config(
    *,
    ...
    return ACTConfig(
        ...
        handle_latent_front_key=str(handle_latent_front_key),
...
class LeRobotActDoorPolicyBackend:
    ...
    def load(
        ...
        config = make_lerobot_act_config(
            ...
            handle_latent_front_key=cfg.get("handle_latent_front_key", "aux.front_handle_latent"),
            handle_latent_front_valid_key=cfg.get(
                "handle_latent_front_valid_key",
                "aux.front_handle_latent_valid",
            ),
            handle_latent_wrist_key=cfg.get("handle_latent_wrist_key", "aux.wrist_handle_latent"),
            handle_latent_wrist_valid_key=cfg.get(
    ...
    def metadata(self, extra_config: Optional[Mapping[str, Any]] = None) -> Dict[str, Any]:
        policy_config = {
            ...
            "handle_latent_front_key": getattr(self.config, "handle_latent_front_key", "aux.front_handle_latent"),
            "handle_latent_front_valid_key": getattr(
                self.config,
                "handle_latent_front_valid_key",
                "aux.front_handle_latent_valid",
            ),
            "handle_latent_wrist_key": getattr(self.config, "handle_latent_wrist_key", "aux.wrist_handle_latent"),
            "handle_latent_wrist_valid_key": getattr(
                self.config,
                "handle_latent_wrist_valid_key",
                "aux.wrist_handle_latent_valid",
            ),
